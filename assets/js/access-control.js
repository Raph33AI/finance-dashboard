...
/* ═══════════════════════════════════════════════════════════════
   ACCESS CONTROL SYSTEM - AlphaVault AI
   VERSION 6.0 - SANS TRIAL AUTOMATIQUE
   Les utilisateurs Basic/Pro ont directement accès uniquement à leurs pages respectives
   ═══════════════════════════════════════════════════════════════ */

console.log('🔐 Access Control System v6.0 initialized (NO AUTO-TRIAL)');
...
async function checkPageAccess(pageName) {
    try {
        ...
        // ✅ 9 - GESTION DES CODES PROMO FREE (PRIORITÉ)
...
function showUpgradeModal(currentPlan, reason) {
    ...
    const messages = {
        no_subscription: {
            title: 'Welcome to AlphaVault AI!',
            description: 'You need to choose a subscription plan to access our premium features.',
            icon: '🚀',
            suggestedPlan: 'Pro',
            ctaText: 'Choose Your Plan',
            ctaColor: 'linear-gradient(135deg, #3b82f6, #8b5cf6)',
...
console.log('✅ Access Control System v6.0 ready (NO AUTO-TRIAL)');
console.log('📊 Available plans:', Object.keys(ACCESS_LEVELS));
console.log('🎯 Pages Common (all plans): 5');
console.log('📦 Pages Basic: +4 (total 9)');
console.log('👑 Pages Pro: +8 (total 17)');
console.log('💎 Pages Platinum: +8 AI/ML (total 25)');
console.log('⚠ AUTO-TRIAL DISABLED - Direct plan access only');
console.log('🛒 Upgrade redirects to: checkout.html');

// ═══════════════════════════════════════════════════════════════
//  RATE LIMITING SYSTEM - VERSION 2.0 (SANS TRIAL)
// ═══════════════════════════════════════════════════════════════

console.log('⏱ Rate Limiting System v2.0 initialized (NO TRIAL)');
...
console.log('✅ Rate Limiting System v2.0 ready (NO TRIAL)');
...
console.log('⚠ TRIAL LIMITS REMOVED - Direct plan limits only');