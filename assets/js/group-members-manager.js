...
class GroupMembersManager {
    ...
    initialize() {
        console.log('👥 Initializing Group Members Manager v2.0...');
                                ...
                                <div class="group-info-edit" style="padding: 20px; background: rgba(102, 126, 234, 0.05); border-radius: 12px;">
                                    ...
                                    <div style="text-align: center; margin-bottom: 24px;">
                                        <div style="position: relative; display: inline-block;">
                                            ...
                                            <button onclick="document.getElementById('groupPhotoInput').click()"
...
console.log('✅ group-members-manager.js loaded (v2.0 - Full Edit + Add Members)');