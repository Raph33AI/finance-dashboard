...
// ✅ AJOUT : URL du Worker pour le système de parrainage
...
function detectAndStoreReferralCode() {
    ...
    if (refCode) {
        ...
        showToast('info', 'Referral Detected!', 'You were invited by a friend. They will earn rewards when you subscribe!');
    } else {
 ...
 */
async function trackReferralSignup(newUser) {
    try {
        ...
        console.log('   Nouvel utilisateur:', newUser.email);
        ...
        if (data.success) {
            ...
            showToast('success', 'Referral Registered!', 'Your friend will be notified of your signup!');
        } else {
...
function initializeEventListeners() {
    // ✅ NOUVEAU : Détecter le code de parrainage au chargement
...
/**
 * Handle email signup
 * ✅ VERSION CORRIGÉE : Gestion robuste des erreurs + Redirection checkout + REFERRAL TRACKING
 */
async function handleEmailSignup(e) {
    e.preventDefault();
    ...
    try {
        ...
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        // ✅ ÉTAPE 4.5 : TRACKER LE PARRAINAGE
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
/**
 * Handle social login (Google, Apple, Microsoft)
 * ✅ MODIFIÉ : Redirection checkout pour nouveaux comptes + REFERRAL TRACKING
 */
async function handleSocialLogin(providerType) {
    if (isProcessing) return;
    ...
    try {
        ...
        if (isNewUser) {
            ...
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            // ✅ NOUVEAU : TRACKER LE PARRAINAGE POUR SOCIAL AUTH
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            await trackReferralSignup(user);
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
console.log('✅ Authentication script loaded - Version optimisée checkout + Gestion robuste des erreurs + REFERRAL TRACKING');